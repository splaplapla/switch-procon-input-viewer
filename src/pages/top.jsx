  ...
  return(
    ...
    <Svg
      ...
      >
        ...
        {/* Left Stick */}
        <circle cx="224" cy="347" r="59" onMouseDown={(e) => onStickDown(e, "left")} />

        {/* Right Stick */}
        <circle cx="632" cy="483" r="59" onMouseDown={(e) => onStickDown(e, "right")} />

        {/* Direction Up */}
        <path d="M325 411.5H346.5H368V462.5L346.5 484L325 462.5V411.5Z" stroke="#030407" strokeWidth="4" />

        {/* Direction Right */}
        <path d="M419 462.5L419 484L419 505.5L368 505.5L346.5 484L368 462.5L419 462.5Z" stroke="#030407" strokeWidth="4" />

        {/* Direction Down */}
        <path d="M325 556.5H346.5H368V505.5L346.5 484L325 505.5V556.5Z" stroke="#030407" strokeWidth="4" />

        {/* Direction Left */}
        <path d="M274 462.5L274 484L274 505.5L325 505.5L346.5 484L325 462.5L274 462.5Z" stroke="#030407" strokeWidth="4" />

        {/* Button X */}
        <circle cx="764" cy="277" r="37" stroke="#030407" strokeWidth="4" />

        {/* Button Y */}
        <circle cx="686" cy="345" r="37" stroke="#030407" strokeWidth="4" />

        {/* Button A */}
        <circle cx="842" cy="345" r="37" stroke="#030407" strokeWidth="4" />

        {/* Button B */}
        <circle cx="764" cy="415" r="37" stroke="#030407" strokeWidth="4" />

        {/* Plus */}
        <circle cx="625" cy="269" r="22" stroke="#030407" strokeWidth="4" />

        {/* Minus */}
        <circle cx="375" cy="269" r="22" stroke="#030407" strokeWidth="4" />

        {/* Home */}
        <circle cx="570" cy="347" r="22" stroke="#030407" strokeWidth="4" />

        {/* ScreenShot */}
        <rect x="408" y="326" width="42" height="42" rx="6" fill={"red"} stroke="#030407" strokeWidth="4" />
